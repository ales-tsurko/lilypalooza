...
fn highlight_color(highlight: Highlight, style: &Style) -> Color {
    ...
    match name {
        ...
        "number" => style.number_color,
        "function" => style.function_color,
        "variable" | "identifier" => style.variable_color,
        "operator" => style.operator_color,
        "processing" => style.processing_color,
        "global" => style.constant_color,
        "constant" | "boolean" | "entity" => style.constant_color,
        "punctuation" | "punctuation.bracket" | "bracket" => style.punctuation_color,
