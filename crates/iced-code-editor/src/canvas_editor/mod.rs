...
pub enum ArrowDirection {
    /// Move or extend selection upward by one line.
    Up,
    /// Move or extend selection downward by one line.
    Down,
    /// Move or extend selection left by one character.
    Left,
    /// Move or extend selection right by one character.
    Right,
}
