...
//! let language = tree_sitter_lilypond::LANGUAGE_LILYPOND;
//! parser
...
///
/// [`node-types.json`]: https://tree-sitter.github.io/tree-sitter/using-parsers#static-node-types
pub const LILYPOND_SCHEM_NODE_TYPES: &str =
    include_str!("../../lilypond-scheme/src/node-types.json");

pub const HIGHLIGHTS_QUERY: &str = include_str!("../../queries/highlights.scm");
pub const HIGHLIGHTS_SCHEME_QUERY: &str = include_str!("../../queries/highlights-scheme.scm");
